...
<%@ page import="com.model.Customer" %> <!-- Change this to your actual package -->
...
response.setHeader("Expires","0");
 ...
 if(session.getAttribute("admin")==null){
    ...
    List<Customer> customers = AdminDAO.viewTable();
...
<div class="container_1 mt-5">
    ...
    <table class="table table-dark-custom text-center mt-3">
        ...
        <tbody>
            <% for (int i = start; i < end; i++) { Customer c = customers.get(i); %>
                <tr>
                    <td><%= i+1 %></td>
                    <td><%= c.getfName()+" "+c.getlName() %></td>
                    <td><%= c.getAccountNo() %></td>
                    <td><%= c.getInitialBal() %></td>
                </tr>
            <% } %>
        </tbody>
    </table>
