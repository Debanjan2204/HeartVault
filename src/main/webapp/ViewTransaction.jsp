...
response.setHeader("Expires","0");
 ...
 if(session.getAttribute("Cust")==null){
    ...
    // Retrieve customer list from DAO
	    ...
	    Table = CustomerDAO.searchTransTable(Long.parseLong(session.getAttribute("Cust").toString()));
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
            <a class="nav-link navbar-item px-lg-4" href="customer_dashboard.jsp"> &#8592 Back</a>
            </li>
